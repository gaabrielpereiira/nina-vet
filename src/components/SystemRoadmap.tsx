        ...
        <div className="space-y-4">
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-6">
            <p className="text-amber-200 text-sm leading-relaxed mb-4">
              Após remixar este projeto, algumas configurações precisam ser revisadas manualmente para garantir o funcionamento completo do sistema.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-white font-medium">Configurar verify_jwt = false nas Edge Functions</p>
                  <p className="text-sm text-slate-400">
                    As funções abaixo precisam ter a verificação de JWT desabilitada para funcionar corretamente no fluxo single-tenant:
                  </p>
                  <div className="mt-2 bg-slate-950 border border-slate-700 rounded-lg p-3">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Acesse o painel do Meta, vá em WhatsApp → Configuration, e configure a URL do webhook (whatsapp-webhook) com o Verify Token salvo nas configurações.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-white font-medium">Configurar a ElevenLabs API Key (opcional)</p>
                  <p className="text-sm text-slate-400">
                    Para respostas em áudio, adicione sua API key da ElevenLabs na aba APIs das configurações. Se não configurar, o agente responderá apenas em texto.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
            <p className="text-xs text-slate-400">
              <strong className="text-amber-400">⚠️ Atenção:</strong> Este checklist é executado automaticamente após cada remix, mas as configurações de webhook e API keys externas precisam ser feitas manualmente no painel respectivo.
            </p>
          </div>
        </div>
      ),
